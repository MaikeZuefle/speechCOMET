...
- **[MuST-SHE](https://aclanthology.org/2020.acl-main.619/)** (Bentivogli et al., 2020): [`speaker gender probing`](data-preparation/03-prepare_mustshe_probe.py)
- **[ContraProST](https://aclanthology.org/2024.wmt-1.119/)** (Tsiamas et al., 2024): [`emotion probing`](data-preparation/04-prepare_contraprost_emotion_probe.py) and [`intonation probing`](data-preparation/04-prepare_contraprost_intonation_probe.py)
